...
class ExperimentContainer {
	 ...
	 *    	- `{ geo: 'US', page: 'index.html' }`
	 *
	 *    Then it is more likely the `E1` will receive more traffic than `E2` since `E1` competes with `E2` evenly on `index.html`
	...
	/**
	 *    An iterator of all the targeting features from all the experiments
